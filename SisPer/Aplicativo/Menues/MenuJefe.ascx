<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MenuJefe.ascx.cs" Inherits="SisPer.Aplicativo.Menues.MenuJefe" %>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="divider"></li>
                                <li><a href="../Aplicativo/Personal_Informe_SalidasVarias.aspx">Informes varios</a></li>
