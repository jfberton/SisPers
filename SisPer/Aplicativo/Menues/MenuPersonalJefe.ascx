<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MenuPersonalJefe.ascx.cs" Inherits="SisPer.Aplicativo.Menues.MenuPersonalJefe" %>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="../Aplicativo/Personal_LegajosSinCerrar.aspx">Días por cerrar</a></li>
                                <li class="divider"></li>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Menu Jefe
                                <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu" role="menu">
