<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Jefe_Ag_AutorizaTurno.aspx.cs" Inherits="SisPer.Aplicativo.Jefe_Ag_AutorizaTurno" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Autorizar dias con turno distinto al que posee</h3>
        </div>
                ...
                <div class="col-md-8">
                    <asp:GridView ID="gv_autorizaciones" runat="server" ForeColor="#717171"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="turno" HeaderText="Turno" ReadOnly="true" DataFormatString="{0:d}" />
                            <asp:BoundField DataField="desde" HeaderText="Desde" ReadOnly="true" DataFormatString="{0:d}" />
                            <asp:BoundField DataField="hasta" HeaderText="Hasta" ReadOnly="true" DataFormatString="{0:d}" />
