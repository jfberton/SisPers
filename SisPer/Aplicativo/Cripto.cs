...
namespace SisPer.Aplicativo
{
    public static class Cripto
    {
        ...
        {
            return Encriptar(textoQueEncriptaremos, "pass75dc@avz12", "s@lAvx", "MD5", 1, "@1B2c3D4e5Frg7H8", 128);
        }
        ...
        {
            return Desencriptar(textoEncriptado, "pass75dc@avz12", "s@lAvx", "MD5", 1, "@1B2c3D4e5Frg7H8", 128);
        }
