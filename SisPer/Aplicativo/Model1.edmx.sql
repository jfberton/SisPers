...
-- --------------------------------------------------
-- Date Created: 12/05/2017 07:33:53
-- Generated from EDMX file: d:\Usuarios\jfberton\Mis Documentos\Desarrollo\SisPer\SisPer\Aplicativo\Model1.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_AgenteAgente12141]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Agentes1214] DROP CONSTRAINT [FK_AgenteAgente12141];
GO
